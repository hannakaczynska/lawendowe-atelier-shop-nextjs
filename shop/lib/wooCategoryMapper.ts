...
export async function getCategoryMap(): Promise<{ categoryMap: Record<string, number>; categoryTree: CategoryNode[] }> {
  // Return cached map if available
  if (categoryMap && categoryTree) {
    return { categoryMap, categoryTree };
  }
