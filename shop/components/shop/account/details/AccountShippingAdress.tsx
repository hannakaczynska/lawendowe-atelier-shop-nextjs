  ...
  return (
    <section className="mb-10 w-full">
      ...
      <label className="flex items-center gap-2 mb-4 cursor-pointer">
        <input type="checkbox" className="accent-[var(--in-stock)]" {...register("shippingSameAsBilling")} />
      ...
      />
      <p className={`text-xs text-[var(--out-of-stock)] h-[18px] md:h-[20px] my-1 md:mb-2 ${errors.shippingLastName ? "opacity-100" : "opacity-0"}`}>
      ...
      />
      <p className={`text-xs text-[var(--out-of-stock)] h-[18px] md:h-[20px] my-1 md:mb-2 ${errors.shippingPostcode ? "opacity-100" : "opacity-0"}`}>
